$(document).ready(function() {
		...
		function inPromise(resolve, reject) {
			$.ajax({
				...
				url: "http://localhost/proj/teacher/getData/back/getData.back.php",
				data: {
					tabel: tabelNo,
					selection: selection
				}, 
				...
				success: function(msg) {
					...
					if ( tabelNo > totalTables) {
						$(".change-me").html('<div class="message">  <button class="confirm cancel">Cancel</button> <button class="confirm sndMail">Submit</button></div>')
