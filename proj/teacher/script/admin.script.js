$(document).ready(function() {
	...
	// 		url: "http://localhost/phpmysql/new/back/admin.back.php",
	// 		data: {
	// 			selection: selection
	// 		}, 
	...
	$(document).on("click", ".sndMail", function() {
		$.ajax({
			method: "POST",
			url: "http://localhost/proj/teacher/back/archive.php",
			data: {
				selection: selection
			},
			beforeSend: function() {
			...
			success: function(msg) {
				succed();
				window.location.href = "http://localhost/proj/teacher/index1.php";
			}
		});
	})

	$(document).on("click", ".cancel", function() {
		window.location.href = "http://localhost/proj/teacher/index.php";
	})
